...
All the environments are registered in the `thomas_sim` extension. They start
...
import thomas_sim.tasks  # noqa: F401


def main():
    """Print all environments registered in `thomas_sim` extension."""
