...
from .thomas_sim_env_cfg import ThomasSimEnvCfg

def define_markers() -> VisualizationMarkers:
    """Define markers with various shapes."""
...
class ThomasSimEnv(DirectRLEnv):
    cfg: ThomasSimEnvCfg

    def __init__(self, cfg: ThomasSimEnvCfg, render_mode: str | None = None, **kwargs):
